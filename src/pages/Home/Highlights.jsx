...
const Highlights = () => {
  return (
    <div className="grid grid-cols-5 grid-rows-3 h-[320px] gap-6">
      ...
      <div className="col-span-3 row-span-1">
        <h1 className="text-5xl text-[#020043] font-semibold text-center">
      ...
      <div className="col-span-1 row-span-2 bg-white shadow-sm rounded-3xl p-4 mt-6">
        <div className="flex gap-2 items-center">
          <h1 className="text-[40px] font-semibold text-[#020043]">4.8</h1>
          <img className="size-7" src={star} alt="" />
        </div>
        <p className="pb-6">
        Over 20,000 Patient
        </p>
